...
void printFontInfo(unsigned long font_info)
{
    ...
    // 文字对齐
    printf("\t%-9s", getFontAlignStr((font_info & FONT_ALIGN_SET_MASK) >> FONT_ALIGN_START_INDEX));
    // 字体加粗
    printf("\t%-5s", ((font_info & FONT_BOLD_SET_MASK) >> FONT_BOLD_START_INDEX)
                         ? "True"
                         : "False");
    // 字体斜体
    printf("\t%-6s", ((font_info & FONT_ITALIC_SET_MASK) >> FONT_ITALIC_START_INDEX)
                         ? "True"
                         : "False");
    // 字体下划线
    printf("\t%-9s", ((font_info & FONT_UNDERLINE_SET_MASK) >> FONT_UNDERLINE_START_INDEX)
                         ? "True"
                         : "False");
